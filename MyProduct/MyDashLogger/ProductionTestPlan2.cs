...
namespace MyProduct.MyDashLogger
{
    ...
    public class ProductionTestTimeController
    {
        ...
        public void Save()
        {
            ...
            bool isTestPlanPassed = m_debugModel.IsPass(MyDUT.FailedTests.Count);
    ...
    public class ProductionTestTimeDebug
    {
        ...
        public bool IsPass(int failTestCount)
        {
            if (IsDebugMode)
            {
                return true;
