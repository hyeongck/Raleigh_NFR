...
{
    public class Aemulus1340 : Base_SMU, iPowerSupply 
    {
        /// <summary>
        /// Need to Debug for using Optionstring & ModelNumber
        /// </summary>
        ...
        {
            API_Name = "SETNPLC"; retVal = aMB1340C.SETNPLC(hSys, (int)Channel, val);
        }
		...
		float iPowerSupply.MeasITraceMode(string strSelection, ePSupply_Channel Channel, ePSupply_IRange IRange, int ReadDelay)
        {
            // need to Modify
            if ((int)Channel < 8)
            {
        ...
        void iPowerSupply.CalSelfCalibrate(string strSelection, ePSupply_Channel Channel)
        {

        }

        double iPowerSupply.CheckDeviceTemperature(string strSelection, ePSupply_Channel Channel)
        {
            return 0;
        }
