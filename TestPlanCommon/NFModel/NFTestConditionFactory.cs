...
{
    public class NFTestConditionFactory
    {
        public static Dictionary<string, string>[] DicTestPA;  // Sheet - Condition_PA : Test Header, Test Condition
        public static Dictionary<string, string> DicTestLabel; // Sheet - Condition_PA : Test Header, Test Label (=dBm, MHz ...)

        public static Dictionary<string, string> DicCalInfo;   // Sheet - CalInfo : CalInfo Header, CalInfo Condition

        public static Dictionary<string, string> DicWaveForm;  // Sheet - WaveForm : WaveformName, WaveformFilePath
        public static Dictionary<string, string> DicWaveFormMutate; // Sheet - WaveForm : WaveformName, WaveformMutateCond
        public static Dictionary<string, string> DicWaveFormAlias; // Sheet - WaveForm : WaveformName, WaveformAlias

        public static Dictionary<string, string>[] DicMipiKey; // Sheet - MIPI : currentTestCondName, currentTestCondValue
        public static Dictionary<string, string>[] DicPwrBlast; // Sheet - Power Blast : currentTestCondName, currentTestCondValue

        public static ArrayList CalList;
    }
    public class NFStructure
    {
    ...
    public static class DataFilePathLib
    {
